...
string[] names2 = new[] { "Ranna", "Raphael", "Harry", "Gregory" };
...
{
  { "Mango", "Orange", "Banana", "Grape" },
  { "Dog", "Cat", "Horse", "Ant" },
  { "Tree", "Flower", "Bush", "Grass" }
};
...
grid2[0, 0] = "Mango"; // assign string values
// and so on
grid2[2, 3] = "Grass";

string[][] jagged = new[] // array of string arrays
{
  new[] { "Mango", "Orange", "Banana" },
  new[] { "Dog", "Cat", "Horse", "Ant" },
  new[] { "Bush", "Grass" }
};
